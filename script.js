...
//all the distances in meters
var distExosphere = 1280000;
var distThermosphere = 640000;
...
$(document).ready(function() {
 ...
 $.get("http://ipinfo.io", function(response) {
    ...
    L.circle(phillyLatLong, distExosphere, {
      color: 'green',
      fillColor: 'green',
      fillOpacity: 0.2
    }).addTo(atmosLayers).bindPopup("This distance brings you to the exosphere. The gases within the earth's exosphere are hydrogen, helium, carbon dioxide, and atomic oxygen. There is no clear boundary between outer space and the exosphere, so the exosphere is sometimes considered a part of outer space.");

    L.circle(phillyLatLong, distThermosphere, {
      color: 'purple',
      fillColor: 'purple',
      fillOpacity: 0.4
    }).addTo(atmosLayers).bindPopup("Traveling this distance brings you to the thermosphere. Temperatures increase with altitude due to absorption of solar radiation. Even though the temperature is high, you would feel cold because it is so near vacuum that there is not enough contact with the few atoms of gas to transfer much heat. The International Space Station orbits within the middle of the thermosphere.");

    L.circle(phillyLatLong, distMesosphere, {
      color: 'orange',
      fillColor: 'orange',
      fillOpacity: 0.2
    }).addTo(atmosLayers).bindPopup("Traveling here would be the equivalent of going to the mesosphere. In the mesosphere, temperature decreases with increasing height. The upper boundary of the mesosphere can be the coldest naturally occurring place on Earth.");

   L.circle(phillyLatLong, distStratosphere, {
      color: 'blue',
      fillColor: 'blue',
      fillOpacity: 0.2
    }).addTo(atmosLayers).bindPopup("This distance brings you to the stratosphere. Here, warmer layers are higher up and cooler layers are farther down. This is in contrast to the troposphere near the earth's surface, which is cooler higher up and warmer farther down. Commercial airliners typically cruise in the stratosphere.");

    L.circle(phillyLatLong, distTroposphere, {
      color: 'red',
      fillColor: '#f03',
      fillOpacity: 0.2
    }).addTo(atmosLayers).bindPopup("This is the extent of the troposphere. The troposphere is the lowest portion of Earth's atmosphere. It contains approximately 80% of the atmosphere's mass and 99% of its water vapor and aerosols. Most of the phenomena we associate with weather occur in the troposphere.");



    L.circle(phillyLatLong, distHadalzone, {
      color: 'purple',
      fillColor: 'purple',
      fillOpacity: 0.2
    }).addTo(oceanLayers).bindPopup("This is the extent of the Hadal Zone. This is as deep as the ocean goes! The hadal zone (named after the realm of Hades, the underworld in Greek mythology) is where you'd find the deepest trenches in the ocean. The low nutrient level and lack of sunlight create hostile living conditions. As no sunlight reaches this layer of the ocean, deep sea creatures have reduced eyesight, with very large eyes for receiving only bioluminescent flashes. ")

    L.circle(phillyLatLong, distAbyssalzone, {
      color: 'green',
      fillColor: 'green',
      fillOpacity: 0.2
    }).addTo(oceanLayers).bindPopup("This is the extent of the Abyssal Zone. This zone remains in perpetual darkness and never receives daylight. Its permanent inhabitants (black swallower, deep-sea anglerfish and giant squid) are able to withstand the immense pressures of the ocean depths.");

    L.circle(phillyLatLong, distBathylzone, {
      color: 'orange',
      fillColor: 'orange',
      fillOpacity: 0.2
    }).addTo(oceanLayers).bindPopup("This is the extent of the Bathyal Zone. Because of the lack of light, some species here do not have eyes (though viperfish and the frill shark are exceptions). Many forms of nekton live in the bathyal zone, such as squid, large whales, and octopuses, but this zone is difficult for fish. Sponges, brachiopods, sea stars, and echinoids are also common in the bathyal zone.");

   L.circle(phillyLatLong, distMesopalegiczone, {
      color: 'blue',
      fillColor: 'blue',
      fillOpacity: 0.2
    }).addTo(oceanLayers).bindPopup("This is the extent of the Mesopelagic Zone, or twilight zone. Although some light penetrates as deep as the mesopelagic zone, it is insufficient for photosynthesis (so plants can't get energy directly from the sun). The general types of life forms found are daytime visiting herbivores, detritivores feeding on dead organisms and fecal pellets, and carnivores feeding on the former types. Examples of animals in the mesopelagic zone are: swordfish, squid, wolf eels, cuttlefish, and other semi-deepsea creatures.");
   
    L.circle(phillyLatLong, distEpipelagiczone, {
      color: 'red',
      fillColor: '#f03',
      fillOpacity: 0.2
    ...
    L.circle(phillyLatLong, distInnercore, {
      color: 'green',
      fillColor: 'green',
      fillOpacity: 0.2
    ...
    L.circle(phillyLatLong, distOutercore, {
      color: 'orange',
      fillColor: 'orange',
      fillOpacity: 0.2
   ...
   L.circle(phillyLatLong, distMantle, {
      color: 'blue',
      fillColor: 'blue',
      fillOpacity: 0.2
    ...
    L.circle(phillyLatLong, distCrust, {
      color: 'red',
      fillColor: '#f03',
      fillOpacity: 0.2
